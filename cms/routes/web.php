    ...
    Route::middleware(['check.user.type:admin'])
        ...
        ->group(function () {
            ...
            */
            ...
            Route::get('/salary/export/excel', [App\Http\Controllers\Admin\SalaryController::class, 'exportExcel'])->name('salary.export.excel');
            Route::post('/salary/send-email', [App\Http\Controllers\Admin\SalaryController::class, 'sendEmail'])->name('salary.send.email');
